...
public class CodeEditor extends StackPane {
  ...
  private final String editingTemplate =
    ...
    "<html>" +
    "<head>" +
    "  <link rel=\"stylesheet\" href=\"" + getClass().getResource("codemirror.css") + "\">" +
    "  <script src=\"" + getClass().getResource("codemirror.js") + "\"></script>" +
  ...
  private String applyEditingTemplate() {
    return editingTemplate.replace("${code}", editingCode).replace("${ext}", SourceExt.sourceExtension(ext)).replace("${mode}",  "" + getClass().getResource("mode/" + SourceExt.codemirrorMode(ext) + ".js"));
  }

  /** sets the current code in the editor and creates an editing snapshot of the code which can be reverted to. */
  public void setCode(String newCode, String ext) {
   ...
   */
  public CodeEditor(String editingCode, String ext) {
